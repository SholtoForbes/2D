...
% function payload = thirdstagesingle(AoA, Alt, theta, v, lat, head)
t1 = cputime;
% AoA = 10;
% Alt = 35000;
% theta = 9; 
...
SCALE = 1; % This scales the characteristic length
...
'03 SREF              1401       0.870\r\n' ...  %aero ref area
'03 VMASSI            1305      ' num2str(2850.1*SCALE^3) ' \r\n' ...   % third stage mass
...
'03 DVBE              1613       ' num2str(v,'%10.4e') '\r\n' ...
'03 PSIVGX            1602       -6.900\r\n' ...     % heading (deg) NOTE THIS IS FROM NORTH
...
fprintf(C,Cstring);
%'03 PSIVGX            1602       -6.900\r\n' ...     % heading (deg)
%'03 BLAT              1605       ' num2str(lat,'%10.4e') '\r\n' ...   % latitude (rad)
%'03 PSIVGX            1602       ' num2str(head,'%10.4e') '\r\n' ...     % heading (deg)
...
loc = findstr('Propmass',cond3);

payload = str2num(cond3(loc+8:loc+13))
